...
# only for testing against Long agent
...
# vs long agent
parser.add_argument('--long', help='Evaluate agent vs long agent', default=False, action='store_true')
...
if __name__ == '__main__':
    ...
    if opts.long:
        sys.path.insert(3, 'AgentLong')
        from AgentLong.hockey_agent import HockeyAgent 
        opponent = HockeyAgent(path=r"C:\UNI_Projekte\RL\homeworks\hockey-env_orig\sac\AgentLong")#._load_model("AgentLong/300_final_model_38240.pth")
    else:
